<?php 
    ...
    if(isset($_POST['submit'])) {
        ...
        $action = $admin->updateDeposited($userid,$val);
        if($action) {
            echo '
                <script>
                    window.location = "updateDeposited.php?s=true";
                </script>;
            ';
        }
    }
                            ...
                            <?php 
                                foreach($clients as $client) {
                                    ...
                                    <tr>
                                        ...
                                        <td>'.$client['email'].'</td>
                                        <td>'.$client['userid'].'</td>
                                        <td>$'.number_format($client['deposited']).'</td>
                                        <td>
                                            <form class="d-flex" method="POST" action="./updateDeposited.php">
                                                <div>
